...
class VideoDetailView extends Component {
  ...
  formateData = data => ({
    ...
    videoUlr: data.video_details.video_url,
    thumbnailUrl: data.video_details.thumbnail_url,
    viewCount: data.video_details.view_count,
    publishedAt: data.video_details.published_at,
    description: data.video_details.description,
    name: data.video_details.channel.name,
    profileImageUrl: data.video_details.channel.profile_image_ulr,
  ...
  getVideoDetails = async () => {
    ...
    if (response.ok) {
      ...
      const updatedData = this.formateData(data)
      this.setState({
  ...
  clickLiked = () => {
    this.setState(prevSts => ({
      isLiked: !prevSts.isLiked,
      isDisLiked: true,
    }))
  }
